...
export default function InsertProduct() {
    ...
    return (
        <div className='container-fluid p-5'>
            ...
            {/* <div className="mt-3 mb-5 col-lg-6 col-md-6 col-12 fs-4">
                <label htmlFor="product_Image" className="form-label fw-bold">Product Image</label>
                <input type="file" onChange={setImage} value={productImage} maxLength={12} className="form-control fs-5" id="product_image" placeholder="Enter Product Image" required />
            </div> */}
